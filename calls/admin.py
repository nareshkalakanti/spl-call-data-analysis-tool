...
class CallDetailsAdmin(AdvancedSearchAdmin, ImportExportModelAdmin, SearchAutoCompleteAdmin_):
    ...
    list_display = ["customer_id", "call_date", "call_type", "transcript", "subject_line", "aht", "summary"]
    ...
    actions = [csvexport]
    CSV_EXPORT_FORMAT_FORM = False
    csvexport_export_fields = ["customer_id", "call_date", "call_type", "transcript", "subject_line", "aht", "summary"]
